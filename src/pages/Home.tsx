...
const Home = () => {
    ...
    return <div className='text-brand-text bg-brand-background text-xl lowercase'>
        ...
        <nav className={`fixed inset-x-0 text-brand-background z-40 ${darkenNav ? 'bg-brand-text/50 backdrop-blur-sm ' : 'bg-transparent'} transition-all duration-300`}>
            <div className='flex justify-between mx-16 py-6 items-center'>
                <div className='grow shrink-0'><a className='inline-block' onClick={(e: React.MouseEvent) => {e.preventDefault(); hero.current?.scrollIntoView()}} href=''><img src={logo} alt='PiesArentSquare'/></a></div>
        ...
        <section ref={hero} id='hero' className={`flex flex-col justify-center text-brand-background ${backgroundColor} h-[calc(100dvh-12rem)] min-h-[500px] relative`}>
            <img ref={background} src={heroImg} alt='' className={`object-bottom object-cover w-full h-full absolute overflow-clip ${blendMode}`} />
            
            <div ref={scrollThreshold} className='relative -top-16'></div>
            <div className='relative px-[10%] py-10'>
                ...
                <BoxedText as='h1' imgRef={background} content="I'm Jeremiah" className='text-[144px]/[.8em] font-extrabold mb-12 whitespace-nowrap' blendMode={blendMode} backgroundColor={backgroundColor} />
        ...
        <section ref={aboutMe} id='about-me' className='flex justify-end py-48 px-[10%]'>
            <BoxedText content='About Me' backgroundColor='bg-brand-background' className='text-7xl font-extrabold mr-12 whitespace-nowrap' />
        ...
        <section ref={projects} id='projects' className='flex flex-row-reverse justify-end py-48 px-[10%] bg-brand-text text-brand-background'>
            <BoxedText content='Projects' backgroundColor='bg-brand-text' className='text-7xl font-extrabold ml-12 whitespace-nowrap' direction='left'/>
            <div className='group max-w-[60ch] flex flex-col gap-24 mt-3'>
        ...
        <section ref={contact} id='contact' className='flex justify-center py-48 px-[10%] bg-brand-primary text-brand-background gap-16'>
